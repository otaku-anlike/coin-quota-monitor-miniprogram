...
import wang.raye.springboot.model.ScheduleCriteria.Criteria;
import wang.raye.springboot.model.ScheduleCriteria.Criterion;
...
public class ScheduleSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(ScheduleCriteria example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated
     */
    public String deleteByExample(ScheduleCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("schedule");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Schedule record) {
        ...
        if (record.getIntervals() != null) {
            sql.VALUES("intervals", "#{intervals,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(ScheduleCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        ScheduleCriteria example = (ScheduleCriteria) parameter.get("example");
        ...
        if (record.getIntervals() != null) {
            sql.SET("intervals = #{record.intervals,jdbcType=VARCHAR}");
        }
        ...
        if (record.getLasttime() != null) {
            sql.SET("lasttime = #{record.lasttime,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(Schedule record) {
        ...
        if (record.getIntervals() != null) {
            sql.SET("intervals = #{intervals,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, ScheduleCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
