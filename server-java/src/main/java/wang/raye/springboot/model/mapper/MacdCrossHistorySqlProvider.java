...
import wang.raye.springboot.model.MacdCrossHistoryCriteria.Criteria;
import wang.raye.springboot.model.MacdCrossHistoryCriteria.Criterion;
import wang.raye.springboot.model.MacdCrossHistoryCriteria;

public class MacdCrossHistorySqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(MacdCrossHistoryCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("macd_cross_history");
     ...
     * @mbg.generated
     */
    public String deleteByExample(MacdCrossHistoryCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("macd_cross_history");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(MacdCrossHistory record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("macd_cross_history");
     ...
     * @mbg.generated
     */
    public String selectByExample(MacdCrossHistoryCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MacdCrossHistory record = (MacdCrossHistory) parameter.get("record");
        MacdCrossHistoryCriteria example = (MacdCrossHistoryCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("macd_cross_history");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(MacdCrossHistory record) {
        SQL sql = new SQL();
        sql.UPDATE("macd_cross_history");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, MacdCrossHistoryCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
