...
import wang.raye.springboot.model.AlertCriteria.Criteria;
import wang.raye.springboot.model.AlertCriteria.Criterion;
import wang.raye.springboot.model.AlertCriteria;

public class AlertSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(AlertCriteria example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated
     */
    public String deleteByExample(AlertCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("alert");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(Alert record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("alert");
     ...
     * @mbg.generated
     */
    public String selectByExample(AlertCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Alert record = (Alert) parameter.get("record");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(Alert record) {
        SQL sql = new SQL();
        sql.UPDATE("alert");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, AlertCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
